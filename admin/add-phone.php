        ...
        <div class="wrapper">
            ...
            <form action="" method="POST">
                <table class="tbl-30">
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="hidden" name="model" value="<?= $modelp ?>">
                            <input type="hidden" name="imei" value="<?= $imeicode ?>">
...
if(isset($_POST['submit']))
{
	...
	if($res2 == true)
	{
		$sql3 = "SELECT * FROM tbl_phone WHERE cusid = $cusid AND cusphone = $cusphone";
...
if(!isset($_POST['add-phone'])){
	echo "<script type='text/javascript'>document.location.href='".SITEURL."admin/check-phone.php';</script>";
} ?>
